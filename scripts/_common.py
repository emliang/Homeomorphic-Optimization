"""Shared helpers for script-style experiment entrypoints."""
...
from homopt.experiments import (  # noqa: E402
...
def script_output_dir(name, output_root=None, family=None):
    root = REPO_ROOT / output_root if output_root is not None else REPO_ROOT / "results"
...
def script_run_output_dir(name, params=None, output_root=None, family=None):
    output_dir = script_output_dir(name, output_root=output_root, family=family)
...
def run_script_experiment(name, params, run_fn, output_dir=None, family=None):
    return record_script_run(
        ...
        params=params,
        run_fn=run_fn,
        output_dir=output_dir or script_run_output_dir(name, params=params, family=family),
    )
...
def make_benchmark_entrypoint(
    ...
    *,
    ...
    base_params = params
    target_output_dir = output_dir or script_output_dir(name, family=family)
