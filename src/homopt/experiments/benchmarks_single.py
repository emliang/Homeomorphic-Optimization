...
def convex_algorithm_comparison(
    ...
    records = {}
    summaries = {}
    has_equalities = bool(getattr(problem, "eq_cons", None)) or int(getattr(problem, "n_eq", 0) or 0) > 0
    violation_scope = "full" if has_equalities else "inequality"
    for algorithm in algorithms:
        ...
        record.setdefault("violation_scope", violation_scope)
