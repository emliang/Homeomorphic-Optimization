...
from homopt.experiments._benchmark_common import merged
from homopt.experiments._comparison_helpers import (
...
from homopt.problems import NonConvexQCProblem, as_learning_problem
...
def build_qcqp_problem_args(
    *,
    ...
    problem_args.update(merged({}, problem_config_overrides))
    return problem_args
