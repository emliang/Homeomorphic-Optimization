"""Shared helpers for Stiefel benchmark scripts."""
...
from homopt.experiments._benchmark_common import artifact_root, normalize_algorithm_config_group, resolve_runtime
...
def stiefel_reference_solver_params(params):
    algorithm_config = normalize_algorithm_config_group(
        ...
        algorithm_config_overrides=params.get("algorithm_config_overrides"),
    )
