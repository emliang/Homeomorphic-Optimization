...
from homopt.learning.bisection_adapters import homeomorphic_bisection
...
from homopt.optim.common import _validate_stepsize_rule
from homopt.optim.first_order_loop import run_first_order_loop
from homopt.optim.updates import AdamOptimizer, GDOptimizer
    ...
    def optimize(self, initial_point=None, verbose=False, seed=2025, input_params=None, objective_params=None):
        ...
        with torch.inference_mode():
            ...
            initial_eval = {
                ...
                "violation": violations_fn(input_params, y_current).reshape(-1),
                "decision": y_current,
                "latent_trajectory": z,
            }
